...
use futures::future::{AndThen, JoinAll, Map};
...
type Intermediate = (JoinAll<Image>, Vec<Vec<Region>>);
pub type AtlasLoader = Map<Map<FileLoader, fn(String) -> (JoinAll<Image>, Vec<Vec<Region>>)>,
                               fn((Vec<Image>, Vec<Vec<Region>>)) -> Atlas>;
