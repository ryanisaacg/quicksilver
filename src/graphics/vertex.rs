...
pub struct Vertex {
    ...
    pub pos: Vector,
    /// If there is a texture attached to this vertex, where to get the texture
    /// data from
    ///
...
pub struct GpuTriangle {
    ...
    ///
    /// All of the vertices used by the triangle should agree on whether it
    /// uses an image, it is up to you to maintain this
...
impl PartialOrd for GpuTriangle {
    fn partial_cmp(&self, other: &GpuTriangle) -> Option<Ordering> { Some(self.cmp(other)) }
}
