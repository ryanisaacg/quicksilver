...
//! }
//! ```
//! `Font::render` renders a string into an image with a given font style. It is not recommended to
//! call this function often, as it is fairly expensive; future updates to Quicksilver should make
//! it cheaper.
//!
