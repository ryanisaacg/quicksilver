// The most basic example- it should just open a black window and set the
// window title to Hello world!
extern crate quicksilver;

use quicksilver::{graphics::WindowBuilder, run, Result, State};
