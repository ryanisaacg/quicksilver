...
async fn app(window: Window, mut gfx: Graphics, mut events: EventStream) -> Result<()> {
    ...
    let mut surface = Surface::new(&gfx, Image::from_raw(&gfx, None, 512, 512, PixelFormat::RGBA)?)?;
    // Set the render area to the surface size
    gfx.set_viewport(0, 0, 512, 512);
    // Draw a circle inside a rectangle
    gfx.fill_rect(&Rectangle::new(Vector::new(350.0, 100.0), Vector::new(100.0, 100.0)), Color::RED);
    ...
    gfx.draw_image(&image, Rectangle::new(Vector::new(400.0, 300.0), Vector::new(400.0, 300.0)));
